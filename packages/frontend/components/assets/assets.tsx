...
export const AssetsPanel = ({ chainId }) => {
    ...
    const [showAllAssets, setShowAllAssetsToggle] = useState(false)

    return (
        <Flex direction="column" flex={1} width="100%">

            <HStack justifySelf="flex-end"><Text>Show Assets With Small Balances</Text><Switch isChecked={showAllAssets} onChange={() => setShowAllAssetsToggle(!showAllAssets)}/></HStack>
